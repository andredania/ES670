...
void lcd_initLcd(void)
{
	...
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(0));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(1));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(2));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(3));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(4));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(5));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(6));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(7));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(8));
	GPIOC_PDDR |= GPIO_PDDR_PDD(LCD_DIR(9));
